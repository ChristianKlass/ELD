    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_number_of_winners', models.IntegerField(default=30)),
            ],
        ),
        migrations.CreateModel(
            name='Draw',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100)),
                ('number_of_winners', models.IntegerField(default=26)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticket_number', models.IntegerField(default=2715, unique=True)),
                ('table_number', models.IntegerField(default=31)),
